...
namespace PHPImageWorkshop\Color;
...
class RGBColor
{
     ...
     *
     * @param \PHPImageWorkshop\Color\RGBColor $color
     *
     * @return \PHPImageWorkshop\Color\RGBColor
     */
    ...
    public function blend(RGBColor $color, $amount)
    {
        return $this->setFromArray(array(
            ...
            ,
            min(255, min($this->getGreen(), $color->getGreen()) + round(abs($color->getGreen() - $this->getGreen())
                    * $amount))
            ,
            min(255,
                min($this->getBlue(), $color->getBlue()) + round(abs($color->getBlue() - $this->getBlue()) * $amount))
            ,
            min(100, min($this->getAlpha(), $color->getAlpha()) + round(abs($color->getAlpha() - $this->getAlpha())
                    * $amount))
        ));
    }
